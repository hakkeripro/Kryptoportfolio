      ...
      <div className="w-full max-w-md space-y-6">
        ...
        {step === 'passphrase' && (
          <form onSubmit={handlePassphraseSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-1">Vault Passphrase</label>
              <input
        ...
        {step === 'passkey' && (
          <div className="space-y-4">
            ...
            {isPasskeySupported() ? (
              ...
              <div className="text-sm text-slate-400 text-center rounded-lg border border-slate-800 bg-slate-900/40 p-3">
            ...
            <button
              ...
              className="w-full text-sm text-slate-500 hover:text-slate-400 py-2 underline"
            >
              Skip for now
            </button>
        ...
        {step === 'done' && (
          <div className="space-y-4 text-center">
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-4 text-left space-y-2 text-sm">
              {!isOffline && email && (
