...
import { binanceVerify } from '../../integrations/binance/binanceApi';
import {
...
export function BinanceConnectForm({ ctx, onConnected }: ConnectFormProps) {
    ...
    <div className="mt-4 space-y-3">
      ...
      <label className="block">
        ...
        <input
          ...
          disabled={loading}
          data-testid="form-binance-apikey"
        />
      </label>
      <label className="block">
        <div className="text-caption text-content-secondary mb-1">API Secret</div>
        <input
          className={inputCls}
          type="password"
          value={apiSecret}
          ...
          disabled={loading}
          data-testid="form-binance-apisecret"
        />
      </label>
      <div className="text-caption text-content-tertiary">
        Read-only API key required. Enable "Read Info" + "Spot & Margin Trading" read permissions.
      ...
      <Button
        ...
        data-testid="btn-binance-connect"
      >
