    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 pt-16 pb-24 text-center max-w-5xl mx-auto w-full">
        ...
        >
          ...
          <br />
          <span className="text-[#FF8400]">that can't see</span> your data.
        </motion.h1>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-mono uppercase tracking-[0.15em]">Open source</span>
          </div>
          <div className="w-px h-4 bg-white/10" />
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-mono uppercase tracking-[0.15em]">No tracking</span>
          </div>
        </motion.div>
      </div>
    </section>
