...
export function isCoinbaseV2FixtureCreds(input: {
  keyName?: string;
...
export function fixtureTransactionsByAccount(accountId: string): FixtureTx[] {
  ...
  if (accountId === 'acc_btc') {
    return [
      {
        ...txBase('tx_buy_btc_1', 'buy', '2025-01-02T12:00:00Z', {
          amount: '0.10',
          currency: 'BTC',
        }),
      ...
      {
        ...txBase('tx_sell_btc_1', 'sell', '2025-02-01T12:00:00Z', {
          amount: '-0.02',
          currency: 'BTC',
        }),
      ...
      {
        ...txBase('tx_trade_btc_out', 'trade', '2025-03-01T12:00:00Z', {
          amount: '-0.03',
          currency: 'BTC',
        }),
  ...
  if (accountId === 'acc_eth') {
    return [
      {
        ...txBase('tx_trade_eth_in', 'trade', '2025-03-01T12:00:00Z', {
          amount: '0.50',
          currency: 'ETH',
        }),
        native_amount: { amount: '900.00', currency: 'EUR' },
      ...
      {
        ...txBase('tx_staking_reward_eth', 'staking_reward', '2025-04-01T12:00:00Z', {
          amount: '0.01',
          currency: 'ETH',
        }),
